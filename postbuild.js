...
<html lang="pt-BR">
  <head>
    ...
    <style id="app-reset">
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      ...
      body{overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#0c0a08;color:#e2e8f0}
  ...
  <body>
    ...
    <noscript>
      <div style="display:flex;height:100%;width:100%;align-items:center;justify-content:center;flex-direction:column;gap:1rem;padding:2rem;text-align:center;background:#0c0a08;color:#e2e8f0">
